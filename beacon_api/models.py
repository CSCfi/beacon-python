...
def load_dataset_table(name=None, description=None, assemblyId=None, version=None, variantCount=None, callCount=None, sampleCount=None, externalUrl=None, accessType=None):
    add_new = Beacon_dataset_table(name=name, description=description, assemblyId=assemblyId, version=version, variantCount=variantCount, callCount=callCount, sampleCount=sampleCount, externalUrl=externalUrl, accessType=accessType)
