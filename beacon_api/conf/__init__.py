...
def parse_config_file(path):
    ...
    config_vars = {
        ...
        'handover_drs': config.get('handover_info', 'drs'),
        'handover_datasets': parse_drspaths(config.get('handover_info', 'dataset_paths')),
        'handover_beacon': parse_drspaths(config.get('handover_info', 'beacon_paths')),
        'handover_base': int(config.get('handover_info', 'handover_base')),
